    ...
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        if ((0, _jsxAstUtils.hasEveryProp)(node.attributes, ['accessibilityActions', 'onAccessibilityAction'])) {
          ...
          var handlerPropType = handlerProp.value.expression.type; // CallExpressions are always assumed valid
          ...
          var actionsPropType = actionsProp.value.expression.type; // CallExpressions are always assumed valid
